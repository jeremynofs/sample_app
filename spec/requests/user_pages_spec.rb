...
describe "User pages" do
  ...
  describe 'profile page' do
    let(:user) { FactoryGirl.create(:user) }
    let!(:m1) { FactoryGirl.create(:micropost, user: user, content: Faker::Lorem.sentence) }
    let!(:m2) { FactoryGirl.create(:micropost, user: user, content: Faker::Lorem.sentence) }
  ...
  describe "edit" do
    ...
    describe "with valid information" do
      ...
      let(:new_email) { 'brand-shiny-new-email@example.com' }
      before do
